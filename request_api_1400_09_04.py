        ...
        if p == 0:
            ...
            if predictions[0].sum() > 0:
                ...
                cv2.rectangle(imtest, (j * WindowShape, i * WindowShape),
                              (j * WindowShape + WindowShape, i * WindowShape + WindowShape), (255, 255, 0),
                              thickness=10, lineType=cv2.LINE_8)
                cv2.putText(imtest, "M", (j * WindowShape, i * WindowShape),
    ...
    for j in range(N):
        ...
        if p == 0:
            ...
            if predictions[0].sum() > 0:
                ...
                k = k + 1
                cv2.rectangle(CalcIm, (j * WindowShape, i * WindowShape),
                              (j * WindowShape + WindowShape, i * WindowShape + WindowShape), (255, 255, 0),
                              thickness=10, lineType=cv2.LINE_8)
                cv2.putText(CalcIm, "C", (j * WindowShape, i * WindowShape), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 255, 255),
                            5)
...
# https://www.eeksforgeeks.org/how-to-display-multiple-images-in-one-figure-correctly-in-matplotlib/
